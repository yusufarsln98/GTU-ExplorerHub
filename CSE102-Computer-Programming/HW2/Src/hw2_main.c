...
{
	int date_day =11, date_month=12, date_year=2000, dayno;
	printf("\n--------------------------------------------------------------------------\n");
...
{
	int start_day = 1, start_month=1, start_year=211;
	int end_day = 1, end_month=1, end_year=2312;
	int numdays;
	printf("\n--------------------------------------------------------------------------\n");
...
/* void print_tabulated (unsigned int r11, double r12, int r13, unsigned int r21, double r22, int r23, unsigned int r31, double r32, int r33, char border) */
void test_print_tabulated() {
	printf("\n--------------------------------------------------------------------------\n");
	printf("| --> Testing test_print_tabulated...                                    |\n");
	printf("--------------------------------------------------------------------------\n");
	print_tabulated(1, -010.0, -1, 222, -0112.12120, 2, 33333, 1.320, -333333, '*');
}
