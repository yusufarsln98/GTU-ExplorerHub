package srclinkedlist;
import java.util.Scanner;

import srclinkedlist.lib.*;
import srclinkedlist.lib.buildings.*;

/**
 * This class is used to demonstrate the StreetLL class
 */
public class Driver 
{
    private Driver() {}
    ...
    /**
     * This function is used to test the StreetLL class
     */
    public static void driver()
    {
        System.out.println("\n====== StreetLL class driver (No user interaction) ======\n");

        // Creating a new street with a length of 100.
        /* Echo */ System.out.println("1[ECHO]--- Create new street with length of 80.\n\n");
        StreetLL street = new StreetLL(80);
    ...
    {
        System.out.println("\n====== StreetLL Demonstration (User interaction) ======\n");
        ...
        StreetLL street = new StreetLL(streetLength);
        int mode;
