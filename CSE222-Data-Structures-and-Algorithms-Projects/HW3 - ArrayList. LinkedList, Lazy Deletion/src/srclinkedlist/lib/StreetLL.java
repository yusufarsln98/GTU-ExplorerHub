package srclinkedlist.lib;

import srclinkedlist.lib.buildings.*;
...
public class StreetLL
{
     ...
     */
    public StreetLL(LinkedList<Building> row1, LinkedList<Building> row2, int length) 
    {
        this.row1 = row1;
        this.row2 = row2;
        setLength(length);
     ...
     */
    protected StreetLL(StreetLL other) throws CloneNotSupportedException 
    {
    ...
    // ----- Fields -----
    private int length;
    private LinkedList<Building> row1 = new LinkedList<>();
    private LinkedList<Building> row2 = new LinkedList<>();
     ...
     */
    public void setRow1(LinkedList<Building> row1) 
    { 
        this.row1 = row1; 
    }
     ...
     */
    public LinkedList<Building> getRow1() 
    { 
        return row1; 
    }
     ...
     */
    // --- Row 2 ---
    public void setRow2(LinkedList<Building> row2) 
    { 
        this.row2 = row2; 
    }
     ...
     * @return LinkedList<Building>
     */
    public LinkedList<Building> getRow2() 
    { 
        return row2; 
    }
     ...
     * @return true.
     */
    public boolean addBuilding(LinkedList<Building> row, Building newBuilding)
    {
     ...
     * @return true.
     */
    public boolean removeBuilding(LinkedList<Building> row, Building otherBuilding)
    {
        // Check for the exceptions
     ...
     */
    private void checkRemoveBuildingValidity(LinkedList<Building> row, Building building) 
    {
        if (this.length == 0)
        {
     ...
     */
    private void checkAddBuildingValidity(LinkedList<Building> row, Building newBuilding) 
    {
        if (this.length == 0)
        {
     ...
     */
    public boolean isBuildingExist(LinkedList<Building> row, Building otherBuilding)
    {
     ...
     */
    @Override
    public StreetLL clone() throws CloneNotSupportedException 
    {
        return new StreetLL(this);
    }
