package srcarrayimproved;
import java.util.Scanner;

import srcarrayimproved.lib.*;
import srcarrayimproved.lib.buildings.*;

/**
 * This class is used to demonstrate the StreetAR class
 */
public class Driver 
{
    private Driver() {}
    /**
     * This function is used to test the StreetAR class
     */
    public static void driver()
    {
        System.out.println("\n====== StreetAR class driver (No user interaction) ======\n");

        // Creating a new street with a length of 100.
        /* Echo */ System.out.println("1[ECHO]--- Create new street with length of 80.\n\n");
        StreetAR street = new StreetAR(80);
        ...
        System.out.println(street.getRow1()[0] + "\n\n");
        ...
        try 
        {
            ...
            buildingReference = street.getRow1()[0].clone();
            ...
            if (buildingReference.equals(street.getRow1()[0]))
            {
                System.out.println("They are equal!" + "\n");
                System.out.println("Hash code of original: " + street.getRow1()[0].hashCode());
    ...
    {
        System.out.println("\n====== StreetAR Demonstration (User interaction) ======\n");
        ...
        StreetAR street = new StreetAR(streetLength);
        int mode;
