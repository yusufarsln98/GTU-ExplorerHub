package srcarraylist.lib;

import srcarraylist.lib.buildings.*;
...
public class StreetAL
{
     ...
     */
    public StreetAL(ArrayList<Building> row1, ArrayList<Building> row2, int length) 
    {
        this.row1 = row1;
        this.row2 = row2;
        setLength(length);
     ...
     */
    protected StreetAL(StreetAL other) throws CloneNotSupportedException 
    {
    ...
    // ----- Fields -----
    private int length;
    private ArrayList<Building> row1 = new ArrayList<>();
    private ArrayList<Building> row2 = new ArrayList<>();
     ...
     */
    public void setRow1(ArrayList<Building> row1) 
    { 
        this.row1 = row1; 
    }
     ...
     */
    public ArrayList<Building> getRow1() 
    { 
        return row1; 
    }
     ...
     */
    // --- Row 2 ---
    public void setRow2(ArrayList<Building> row2) 
    { 
        this.row2 = row2; 
    }
     ...
     * @return ArrayList<Building>
     */
    public ArrayList<Building> getRow2() 
    { 
        return row2; 
    }
     ...
     * @return true.
     */
    public boolean addBuilding(ArrayList<Building> row, Building newBuilding)
    {
     ...
     */
    private void checkRemoveBuildingValidity(ArrayList<Building> row, Building building) 
    {
        if (this.length == 0)
        {
     ...
     */
    private void checkAddBuildingValidity(ArrayList<Building> row, Building newBuilding) 
    {
        if (this.length == 0)
        {
     ...
     */
    public boolean isBuildingExist(ArrayList<Building> row, Building otherBuilding)
    {
