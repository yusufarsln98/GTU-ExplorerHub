package srcarraylist;
import java.util.Scanner;

import srcarraylist.lib.*;
import srcarraylist.lib.buildings.*;

/**
 * This class is used to demonstrate the StreetAL class
 */
public class Driver 
{
    private Driver() {}
    ...
    /**
     * This function is used to test the StreetAL class
     */
    public static void driver()
    {
        System.out.println("\n====== StreetAL class driver (No user interaction) ======\n");

        // Creating a new street with a length of 100.
        /* Echo */ System.out.println("1[ECHO]--- Create new street with length of 80.\n\n");
        StreetAL street = new StreetAL(80);
    ...
    {
        System.out.println("\n====== StreetAL Demonstration (User interaction) ======\n");
        ...
        StreetAL street = new StreetAL(streetLength);
        int mode;
