...
/**
 * This class is used to demonstrate the Street class
 */
public class Main 
{
    /**
     * This method is the main method of the program. It calls the driver method and the user
     * interaction method
    ...
    private static void driver()
    {
        ...
        // Create house1
        House house1 = new House(5, 20, 12, "green", "Barney Stinson");
        ...
        street.addBuilding(street.getRow1(), new BuildingOnStreet(house1, 2));
        /* Echo */ System.out.println("5[ECHO]--- Add house1 to the 1st row of the street in 2 position.\n\n");

        // Create office1
        Office office1 = new Office(5, 20, "News Center", "Robin Scherbatsky");
        ...
        street.addBuilding(street.getRow1(), new BuildingOnStreet(office1, 12));
        /* Echo */ System.out.println("8[ECHO]--- Add office1 to the 1st row of the street in 12 position.\n\n");

        // Create market1
        Market market1 = new Market(10, 10, "10:00", "21:00", "Lilly Aldrin");
        ...
        street.addBuilding(street.getRow1(), new BuildingOnStreet(market1, 20));
        /* Echo */ System.out.println("11[ECHO]--- Add market1 to the 1st row of the street in 20 position.\n\n");

        // Create house2
        House house2 = new House(15, 40, 18, "Red", "Marshall Eriksen");
        ...
        street.addBuilding(street.getRow1(), new BuildingOnStreet(house2, 35));
        /* Echo */ System.out.println("14[ECHO]--- Add house2 to the 1st row of the street in 35 position.\n\n");

        // Create playground1
        Playground playground1 = new Playground(26);
        ...
        street.addBuilding(street.getRow1(), new BuildingOnStreet(playground1, 52));
        ...
        // Create office2
        Office office2 = new Office(15, 40, "Architectural Office", "Ted Mosby");
        ...
        street.addBuilding(street.getRow2(), new BuildingOnStreet(office2, 2));
        /* Echo */ System.out.println("21[ECHO]--- Add office2 to the 2nd row of the street in 2 position.\n\n");

        // Create house3
        House house3 = new House(10, 50, 8, "Lilac", "Tracy McConnell");
        ...
        street.addBuilding(street.getRow2(), new BuildingOnStreet(house3, 17));
        /* Echo */ System.out.println("24[ECHO]--- Add house3 to the 2nd row of the street in 17 position.\n\n");

        // Create office3
        Office office3 = new Office(15, 20, "Taxi Driver", "Ranjit");
        ...
        street.addBuilding(street.getRow2(), new BuildingOnStreet(office3, 28));
        /* Echo */ System.out.println("27[ECHO]--- Add office3 to the 2nd row of the street in 28 position.\n\n");

        // Create market2
        Market market2 = new Market(25, 12, "14:00", "02:00", "Maclaren's Irish Pub");
        ...
        street.addBuilding(street.getRow2(), new BuildingOnStreet(market2, 45));
        ...
        BuildingOnStreet ref = street.getRow2()[0];
        ...
        System.out.println(street.getRow1()[0].getBuilding() + "\n\n");
        ...
        try 
        {
            ...
            buildingReference = street.getRow1()[0].getBuilding().clone();
            ...
            if (buildingReference.equals(street.getRow1()[0].getBuilding()))
            {
                System.out.println("They are equal!" + "\n");
                System.out.println("Hash code of original: " + street.getRow1()[0].getBuilding().hashCode());
    ...
    {
        System.out.println("\n====== Street Demonstration (User interaction) ======\n");
        ...
        Street street = new Street(streetLength);
        int mode;
