...
import lib.binarysearchtreetoavltree.TreePrinter.PrintableNode;
...
public class BinaryTree<E> implements Serializable {
	 ...
	 * Adds element to StringBuilder with indentation.
	 ...
	 */
	protected static class Node<E> implements Serializable, PrintableNode {
		...
		// ----- To make node printable -----
		/**
		 * This function returns the left child of the current node.
		 * 
		...
		/**
		 * @return The height of the right and left subtrees, and the value of the node.
		 */
		@Override
